 ...
 *      }
 *  },
 *  itemOperations={"GET", "POST", "PUT", "DELETE", "increment"={
 *      "method"="post", 
...
class Invoice
{
     ...
     * @Groups({"invoices_read", "customers_read", "invoices_subresource"})
     * @Assert\NotBlank(message="La date d'envoi doit être renseignée")
     * @Assert\Choice(choices={"SENT", "PAID", "CANCELLED"}, message="le status doit être valide")
     */
    private $status;
    ...
    /**
     * Récupére le User à qui appartient la facture
